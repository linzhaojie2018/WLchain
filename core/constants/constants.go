...
const (
	...
	//抵押币计算公式 coin = INITIAL_BASE_TARGET / block.BaseTarget * MINING_RATIO
	//BASE_TARGET_180 / block.BaseTarget = 所需硬盘容量T
	INITIAL_BASE_TARGET int64  = 18325193796
	MAX_BASE_TARGET int64 = 18325193796
)
