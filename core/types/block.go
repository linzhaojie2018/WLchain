...
type Header struct {
	...
	PlotterId               *big.Int        `json:"plotterId"   gencodec:"required"`   
	BaseTarget              *big.Int        `json:"baseTarget"   gencodec:"required"` 
	GenerationSignature     []byte          `json:"generationSignature"   gencodec:"required"` 
	GeneratorPublicKey      []byte          `json:"generatorPublicKey"   gencodec:"required"` 
	BlockSignature          []byte          `json:"blockSignature"   gencodec:"required"` 
}
