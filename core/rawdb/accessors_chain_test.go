...
func TestBlockReceiptStorage(t *testing.T) {
	...
	tx1 := types.NewTransaction(types.Binary,1, common.HexToAddress("0x1"), big.NewInt(1), 1, big.NewInt(1), nil)
	tx2 := types.NewTransaction(types.Binary,2, common.HexToAddress("0x2"), big.NewInt(2), 2, big.NewInt(2), nil)
