...
func (ec *Client)SuperNodeAt(ctx context.Context, account common.Address, blockNumber *big.Int)(bool,error){
	var result bool
	err := ec.c.CallContext(ctx, &result, "eth_isSuperNode", account, toBlockNumArg(blockNumber))
	return result, err
}
